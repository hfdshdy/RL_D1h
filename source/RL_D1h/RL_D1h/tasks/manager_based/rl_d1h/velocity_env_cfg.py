...
from RL_D1h.tasks.manager_based.rl_d1h.sensors import LiftMaskCfg

##
# Pre-defined configs
##
from RL_D1h.tasks.manager_based.rl_d1h.terrain_config import ROUGH_TERRAINS_CFG
...
class ActionsCfg:
    ...
    shoudler_thigh_joint_pos = mdp.JointPositionActionCfg(
        asset_name="robot",
...
class EventCfg:
    ...
    #     mode="startup",
    #     params={
    #         "asset_cfg": SceneEntityCfg("robot", joint_names=[".*hip_joint", ".*calf_joint"]),
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="base_link"), "threshold": 100.0},
    )
